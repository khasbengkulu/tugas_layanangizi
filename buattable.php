...
$buat1="CREATE TABLE `layanangizi`.`pasien`(`id` int(11) AUTO_INCREMENT NOT NULL,`norm` varchar(10)NOT NULL , `noidpasien` varchar(20)NOT NULL, `jenisid` varchar(15)NOT NULL, `namapasien` varchar(50)NOT NULL, `alamat` varchar(100)NOT NULL, `agama` varchar(30)NOT NULL, `golongandarah` varchar(2)NOT NULL, `tanggallahir` date NOT NULL, `jeniskelamin` varchar(15)NOT NULL,`waktudaftar` varchar(35)NOT NULL, PRIMARY KEY(`id`)) ENGINE = InnoDB;";
