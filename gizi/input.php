...
<tr>
 		<td>No RM</td>
 		<td><input type="text" name="b" maxlength="10" required autocomplete="off" autofocus size="25px"></td>
 </tr>
 <tr>
	<td>WAKTU LAYANAN</td>
	<td><input type="datetime-local" name="c"  required  autocomplete="off"></td>
</tr>
<tr>
 		<td>DIET</td>
 		<td><input type="text" name="d" maxlength="35" required autocomplete="off"></td>
 </tr>
